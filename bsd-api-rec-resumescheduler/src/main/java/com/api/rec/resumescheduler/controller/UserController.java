...
import com.api.rec.resumescheduler.model.user.PostConfirmationRequestModel;
import com.api.rec.resumescheduler.model.user.PostConfirmationResponseModel;
import com.api.rec.resumescheduler.model.user.PostUserAddRequestModel;
import com.api.rec.resumescheduler.model.user.PostUserAddResponseModel;
import com.api.rec.resumescheduler.model.user.PostUserChangePasswordRequestModel;
import com.api.rec.resumescheduler.model.user.PostUserChangePasswordResponseModel;
import com.api.rec.resumescheduler.model.user.PostUserEditRequestModel;
import com.api.rec.resumescheduler.model.user.PostUserEditResponseModel;
import com.api.rec.resumescheduler.model.user.PostUserRegisterRequestModel;
import com.api.rec.resumescheduler.model.user.PostUserRegisterResponseModel;
import com.api.rec.resumescheduler.service.UserService;
...
public class UserController {
	...
	@Transactional
	public HttpEntity<?> postUserRegister(@Valid @RequestBody PostUserRegisterRequestModel requestModel) throws Exception {
		String fid = new Uid().generateString(20);
		log.info("[fid:" + fid + "] requestModel : " + objectMapper.writeValueAsString(requestModel));
		
		PostUserRegisterResponseModel responseModel = userService.postUserRegister(requestModel);
