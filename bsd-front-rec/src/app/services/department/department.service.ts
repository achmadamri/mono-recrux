...
export class DepartmentService {
  util: Util = new Util();
  // local
  apiUrl = isDevMode() ? 'http://localhost:2082/department' : 'https://amplifio.tech/2082/department';
  // codespace
  // apiUrl = isDevMode() ? '/apidepartments/department' : 'https://amplifio.tech/2082/department';
