...
export class ResumeService {
  util: Util = new Util();
  apiUrl = isDevMode() ? 'http://localhost:2082/resume' : 'https://app.amplifio.tech/2082/resume';
  // codespace
  // apiUrl = isDevMode() ? '/apidepartments/resume' : 'https://app.amplifio.tech/2082/resume';
