...
export class JobService {
  util: Util = new Util();
  apiUrl = isDevMode() ? 'http://localhost:2082/job' : 'https://app.amplifio.tech/2082/job';
  // codespace
  // apiUrl = isDevMode() ? '/apidepartments/job' : 'https://app.amplifio.tech/2082/job';

  constructor(private httpClient: HttpClient) { }
  
  getJobDepartmentList(getJobDepartmentListRequest: GetJobDepartmentListRequest, length: number, pageSize: number, pageIndex: number): Observable<GetJobDepartmentListResponse> {
