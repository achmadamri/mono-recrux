...
export class DashboardService {
  util: Util = new Util();
  // local
  // apiUrl = isDevMode() ? 'http://localhost:2082/dashboard' : 'https://domain.com/2082/dashboard';
  // codespace
  apiUrl = isDevMode() ? '/apidepartments/dashboard' : 'https://domain.com/2082/dashboard';
